  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      <section className="mb-16 text-center">
        ...
        <p className="mt-3 text-earth-600">Have a question about yoga therapy? Send us a message.</p>
        <p className="mt-4 text-earth-600">
          Prefer email? You can also reach us directly at{" "}
          <a href="mailto:therapy@yogicsystem.com" className="font-medium text-orange-600 hover:underline">
        ...
        <div className="rounded-2xl border border-earth-200 bg-white p-10 shadow-sm">
          <form action="https://formspree.io/f/xwvrljdo" method="POST">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label htmlFor="firstName" className="mb-2 block text-sm font-medium text-earth-700">
                  First Name
                </label>
                <input
                  id="firstName"
              ...
              <div>
                <label htmlFor="lastName" className="mb-2 block text-sm font-medium text-earth-700">
                  Last Name
                </label>
                <input
                  id="lastName"
              ...
              <div>
                <label htmlFor="email" className="mb-2 block text-sm font-medium text-earth-700">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="phone" className="mb-2 block text-sm font-medium text-earth-700">
                  Phone
                </label>
                <input
                  id="phone"
